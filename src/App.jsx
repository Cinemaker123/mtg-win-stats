...
function LandingPage({ onSelectPlayer, onShowGlobalStats, isDark, onToggleDark }) {
...
// Global Stats View Component - shows statistics across all players
function GlobalStatsView({ onBack, isDark, onToggleDark }) {
  const isMobile = useIsMobile();
